...
<?php else: ?>
    ...
    <section class="<?php echo e($block->classes); ?> my-20">
      <div class="container-fluid post-grid-filter-vue">
        <post-grid-filter
          ...
          :post-type='<?php echo json_encode($post_type, 15, 512) ?>'
  ...
  <?php endif; ?>
<?php endif; ?>
<?php /**PATH /nas/content/live/acumenbw/wp-content/themes/sage/resources/views/blocks/post-grid-with-filter.blade.php ENDPATH**/ ?>