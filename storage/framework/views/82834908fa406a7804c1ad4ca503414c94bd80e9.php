...
<?php else: ?>
    <?php if(!empty($cards)): ?>
        <section class="<?php echo e($block->classes); ?> container-fluid">
            <div class="<?php echo e($divider); ?> py-5 md:py-20 grid grid-cols-1 <?php echo e($grid_classes); ?> gap-5 md:gap-20">
                <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginal5f1c24da064cdf37917762bf37a30d0804319ee8 = $component; } ?>
<?php $component = App\View\Components\Card::resolve(['card' => $card,'headingTag' => $heading_primary,'color' => $card_style,'isLink' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /nas/content/live/acumenbw/wp-content/themes/sage/resources/views/blocks/unstructured-cards.blade.php ENDPATH**/ ?>