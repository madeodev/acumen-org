...
class ProgramSettings extends Field
{
    /**
     ...
     * @var string
     */
    public $parent = 'edit.php?post_type=program';
    ...
    {
        $programSettings = new FieldsBuilder('program_settings');
