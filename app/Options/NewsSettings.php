...
class NewsSettings extends Field
{
    /**
     ...
     * @var string
     */
    public $parent = 'edit.php?post_type=news';
    ...
    {
        $newsSettings = new FieldsBuilder('news_settings');
