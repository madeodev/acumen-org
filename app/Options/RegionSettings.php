...
class RegionSettings extends Field
{
    /**
     ...
     * @var string
     */
    public $parent = 'edit.php?post_type=region';
    ...
    {
        $regionSettings = new FieldsBuilder('region_settings');
