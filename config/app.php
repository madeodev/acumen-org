...
return [
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\GutenbergProvider::class,
        App\Providers\GravityFormsProvider::class,
        App\Providers\CustomPostTypeProvider::class,
        App\Providers\TaxonomyProvider::class,
        App\Providers\AdminSettingsProvider::class,
        App\Providers\EndpointProvider::class,
        App\Providers\AcfProvider::class,
        App\Providers\PageCacheProvider::class,
    ],
